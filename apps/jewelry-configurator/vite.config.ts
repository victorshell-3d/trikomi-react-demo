...
const dynamicAlias = useLocalSdk ? {
  ...
  '@trikomi/jewelry': path.resolve(__dirname, '../../../3dviewer/packages/jewelry/src/index.ts')
} : {};
...
export default defineConfig(({ _mode }) => ({
  ...
  publicDir: '../../public',
  build: {
    outDir: '../../dist/jewelry-configurator',
    emptyOutDir: true
  },
  define: {
  ...
  plugins: [react(), ...(useLocalSdk ? [serveSecurityTxtPlugin()] : [])],
